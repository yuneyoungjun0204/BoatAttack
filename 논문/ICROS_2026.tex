...
누적 보상은 약 1.1M 스텝 이후 수렴하며, 엔트로피는 점차 감소해 결정론적 정책으로 수렴한다. 정책·가치 손실의
동반 감소는 MA-POCA의 안정적 수렴을 뒷받침한다.
...
Buffer size & 10240\\ \hline
Learning rate & 0.0003 (linear)\\ \hline
Beta (entropy) & 0.005\\ \hline
Epsilon (clip) & 0.2\\ \hline
Lambda (GAE~\cite{ref20}) & 0.95\\ \hline
Num epoch & 3\\ \hline
Gamma & 0.99\\ \hline
Time scale & 10\\ \hline
Max steps & $5\times10^{6}$\\ \hline
\end{tabular}
\end{table}

\begin{figure}[t]\centering\figph{fig11_reward.png}
\figcap{보상 수렴 그래프}{Reward Convergence graph}\label{fig:reward}\end{figure}
