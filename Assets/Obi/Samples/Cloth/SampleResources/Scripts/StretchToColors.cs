...
namespace Obi.Samples
{
    ...
    public class StretchToColors : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            cloth.OnInterpolate += Cloth_OnInterpolate;
        ...
        private void Cloth_OnInterpolate(ObiActor actor, float stepTime, float substepTime)
        {
            ...
            if (dc != null && sc != null)
            {
                ...
                for (int j = 0; j < cloth.solverBatchOffsets[(int)Oni.ConstraintType.Distance].Count; ++j)
                {
                ...
                for (int i = 0; i < cloth.solverIndices.count; ++i)
                {
                    if (counts[i] > 0)
                    {
