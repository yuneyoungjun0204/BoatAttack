...
namespace Obi
{
    public class ComputeTearableClothRenderSystem : ObiClothRenderSystem, RenderSystem<ObiTearableClothRenderer>
    {
        public Oni.RenderingSystemType typeEnum { get => Oni.RenderingSystemType.TearableCloth; }

        public RendererSet<ObiTearableClothRenderer> renderers { get; } = new RendererSet<ObiTearableClothRenderer>();
        ...
        public ComputeTearableClothRenderSystem(ObiSolver solver) : base(solver)
        {
