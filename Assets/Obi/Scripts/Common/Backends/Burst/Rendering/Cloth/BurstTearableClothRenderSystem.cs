...
namespace Obi
{
    public class BurstTearableClothRenderSystem : ObiClothRenderSystem, RenderSystem<ObiTearableClothRenderer>
    {
        ...
        public BurstTearableClothRenderSystem(ObiSolver solver) : base(solver)
        {
        }
